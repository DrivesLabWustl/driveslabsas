...
The goal of ``r params$package`` is to provide helpful SAS Macros for the [Roe Lab at Washington University in Saint Louis](https://roelab.wustl.edu/).
...
```bash
git clone https://github.com/`r params$github`/`r params$package`
```

<br />

Or you can download a zipped version of the repository [here](https://github.com/`r params$github`/`r params$package`/archive/refs/heads/main.zip), and unzip in a suitable location.
